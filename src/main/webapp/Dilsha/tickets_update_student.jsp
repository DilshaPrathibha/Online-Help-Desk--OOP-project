...
<c:if test="${ticket != null}">
    ...
    <div class="update-container">
        <h2>Update Ticket</h2>
        <form action="${pageContext.request.contextPath}/student/edit-ticket" method="post">
			...
			<input type="text" name="studentId" id="studentId" value="${ticket.studentId}" readonly />
		    ...
		    <div class="button-group">
		        <a href="${pageContext.request.contextPath}/student/tickets" class="btn btn-cancel">Cancel</a>
